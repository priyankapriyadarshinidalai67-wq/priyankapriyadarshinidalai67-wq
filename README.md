...
I am a passionate developer focused on Artificial Intelligence and Machine Learning, with a strong foundation in Python and Data Structures & Algorithms. I enjoy exploring intelligent systems that can retrieve, understand, and generate useful answers from real-world knowledge.

- 🐍 **Python Developer** | 🤖 **AI & ML Explorer**
- 🧠 **RAG & GenAI Learner**
- 🧩 **DSA Practitioner** | 🗄️ **Database Explorer**
- ⚡ **Problem Solver** | 🚀 **Learning New Tech Every Day**
...
- 🧠 **AI Projects**: Building practical AI-powered solutions instead of just following tutorials.
- 🔎 **RAG Systems**: Exploring how intelligent systems can retrieve, understand and generate useful answers from real-world knowledge.
- ⚡ **Skill-Based Applications**: Creating projects that connect AI with practical problems.
...
|--------------|-------------|
| 🧠 **AI Powered Skill Gap Analyzer** | AI-based resume analysis and skill-matching system that identifies missing skills and generates personalized learning recommendations. |
| 🚨 **RootCause AI** | AI-powered system designed to help identify and resolve operational problems through intelligent analysis. |
| 🏥 **GIET Medicover** | Healthcare operations platform combining patient management, emergency workflows and analytics. |
| 🌐 **Personal Portfolio** | A personal developer portfolio showcasing my projects, skills and journey in AI/ML. |

---

## 🌱 Currently Learning

`RAG` • `GenAI` • `LLMs` • `DSA` • `Machine Learning` • `Backend Development`

<br>

<div align="center">
  <h3>🎯 2026 Mission</h3>
  <i><b>« Learn less. Build more. Understand deeply. 🚀 »</b></i>
</div>
